...
namespace HotUpdate
{
    ...
    public class ABDownloader
    {
        ...
        {
            HotUpdateManager.Instance.OnOneFileDownload?.Invoke(GetDownloadResSize());
            // 保存待下载的资源信息并设置下载状态
            ...
            string packPath = Path.Combine(Application.persistentDataPath, _abVersionItem.ABName.Replace('\\', '/'));
