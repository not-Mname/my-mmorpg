...
public class PlayerController : MonoBehaviour
{
    ...
    private BattleUnit _character;
    public BattleUnit character { get{ return _character; } set { _character = value; Init(); } }
    ...
    private void Init()
    {
        JumpHeight = 1.5f;
        Gravity = -9.81f;
        Speed = GameObjectTool.LogicToWorld(character.Define.Speed);
        RunSpeed = 10;
        turnAngle = 15f;
        if (_agent == null)
        {
