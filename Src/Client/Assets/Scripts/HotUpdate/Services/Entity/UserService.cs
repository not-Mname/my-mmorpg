...
namespace Services
{
    class UserService : Singleton<UserService>, IDisposable, IInitializable
    {
        ...
        void OnUserGameEnter(object sender, UserGameEnterResponse response)
        {
            ...
            if(this.OnGameEnter != null)
            {
                ...
                if(response.Character != null)
                {
                    ...
                    ItemManager.Instance.Init(response.Character.Items.ToList());
                    BagManager.Instance.Init(response.Character.Bag);
                    EquipManager.Instance.Init(response.Character.Equips.ToArray());
                    QuestManager.Instance.Init(response.Character.Quests.ToList());
                    FriendManager.Instance.Init(response.Character.Friends.ToList());
