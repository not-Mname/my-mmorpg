...
-- --------------------------------------------------
-- Date Created: 04/13/2025 19:10:04
-- Generated from EDMX file: D:\data\mmorpg\MyMmorpg\Src\Server\GameServer\GameServer\Entities.edmx
-- --------------------------------------------------
...
GO
IF OBJECT_ID(N'[dbo].[FK_TCharacterItemTCharacter]', 'F') IS NOT NULL
    ALTER TABLE [dbo].[CharacterItems] DROP CONSTRAINT [FK_TCharacterItemTCharacter];
GO
IF OBJECT_ID(N'[dbo].[FK_TCharacterBagTCharacter]', 'F') IS NOT NULL
    ALTER TABLE [dbo].[CharacterBags] DROP CONSTRAINT [FK_TCharacterBagTCharacter];
GO
...
ALTER TABLE [dbo].[CharacterItems]
ADD CONSTRAINT [FK_TCharacterItemTCharacter]
...
-- Creating non-clustered index for FOREIGN KEY 'FK_TCharacterItemTCharacter'
CREATE INDEX [IX_FK_TCharacterItemTCharacter]
